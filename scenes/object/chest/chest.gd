...
@onready var intactable_component: InteractableComponent = $intactableComponent
...
func _ready() -> void:
	intactable_component.interactivable_activated.connect(on_interactable_activated)
	intactable_component.interactivable_deactivated.connect(on_interactable_deactivated)
...
func _unhandled_input(event: InputEvent) -> void:
	if in_range:
		if event.is_action_pressed("show_dialogue"):
			...
			ballon.start(load("res://dialogue/conversation/chest.dialogue"), dialogue_start_command)
