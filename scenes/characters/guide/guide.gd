...
@onready var interactable_component: InteractableComponent = $IntactableComponent
@onready var interactable_label_component : Control = $InteractableLabelComponent

var in_range: bool

func _ready() -> void:
	interactable_component.interactivable_activated.connect(on_interactable_activated)
	interactable_component.interactivable_deactivated.connect(on_interactable_deactivated)
